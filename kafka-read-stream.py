...
def main():
   ...
   query = spark.readStream.format("kafka")\
      .option("kafka.bootstrap.servers", "rc1b-bbsaq47221abs794.mdb.yandexcloud.net:9091") \
   ...
   df.write.format("text").save("s3a://dataproc-bucket-789/kafka-read-stream-output")
